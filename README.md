...
- Extend to batched training across multiple examples (currently single-example)
- Add ReLU activations in hidden layers and compare convergence behavior
- Add a real dataset with proper train/test split
- Compare results against an equivalent PyTorch implementation
...
Both notebooks run independently — no shared dependencies beyond NumPy.
